...
const LEVELS = [
  ...
  { code: 'a2', label: 'A2', name: 'Elementary', desc: 'Simple conversations on familiar topics.', icon: 'BookOpenLevel', gradient: 'from-cyan-500 to-blue-400', glow: 'shadow-cyan-500/25', border: 'hover:border-cyan-500/50', badge: 'bg-cyan-500/20 text-cyan-300' },
  ...
  { code: 'c2', label: 'C2', name: 'Proficient', desc: 'Near-native precision and fluency.', icon: 'StarLevel', gradient: 'from-yellow-400 to-amber-300', glow: 'shadow-yellow-400/25', border: 'hover:border-yellow-400/50', badge: 'bg-yellow-400/20 text-yellow-300' },
]
