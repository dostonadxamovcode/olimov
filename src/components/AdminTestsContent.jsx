...
const LEVEL_CONFIG = {
  ...
  b1: { label: 'B1', name: 'Pre-Intermediate',   color: { background: 'rgba(139, 92, 246, 0.2)', color: '#c4b5fd', border: '1px solid rgba(139, 92, 246, 0.3)' } },
  b2: { label: 'B2', name: 'Intermediate',       color: { background: 'rgba(249, 115, 22, 0.2)', color: '#fdba74', border: '1px solid rgba(249, 115, 22, 0.3)' } },
