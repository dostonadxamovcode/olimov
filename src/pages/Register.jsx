...
export default function Register() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      await googleLogin()
      // onAuthStateChanged fires → LoginGate redirects automatically
    } catch (err) {
        ...
        <div className="relative rounded-3xl p-8 overflow-hidden"
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-xs mt-1" style={{ color: '#475569' }}>{t('register.subtitle')}</p>
            </div>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            {error && (
              <div className="rounded-xl px-4 py-3 flex items-start gap-2.5 animate-fadeIn"
            ...
            >
              {loading ? (
                <span className="flex items-center gap-2.5">
                  <ButtonSpinner /> {t('register.registering')}
                </span>
              ) : (
            ...
            <div className="flex items-center gap-3 py-1">
              ...
              <span className="text-xs font-medium px-2" style={{ color: '#334155' }}>{t('register.orContinueWith')}</span>
              <div className="flex-1 h-px" style={{ background: 'rgba(255,255,255,0.07)' }} />
            </div>
