                ...
                <div className="relative rounded-3xl p-8 overflow-hidden"
                    ...
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-xs mt-1" style={{ color: '#475569' }}>Log in to your account</p>
                        </div>
                    </div>

                    {/* Heading */}
                    <div className="mb-7">
                        <h1 className="text-2xl font-bold mb-1.5 tracking-tight" style={{ color: '#f1f5f9' }}>Welcome back</h1>
                        <p className="text-sm" style={{ color: '#475569' }}>Enter your credentials to continue</p>
                    </div>

                    <form onSubmit={submit} className="space-y-4">

                        <Field icon={<Mail size={15} />} label="Email" type="email" placeholder="your@email.com" value={form.email} onChange={set('email')} />
                        <Field icon={<Lock size={15} />} label="Password" type="password" placeholder="••••••••" value={form.password} onChange={set('password')} />
