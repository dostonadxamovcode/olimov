...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    element: <MainLayout />,
    children: [
      // No LazyPage Suspense here — MainLayout Suspense hides Footer until the page loads
      { index: true,                    element: <Home /> },
      { path: 'about',                  element: <AboutPage /> },
      { path: 'tools',                  element: <Tools /> },
      { path: 'courses',                element: <Courses /> },
      { path: 'services/listening',     element: <Listening /> },
      { path: 'services/reading',       element: <Reading /> },
      { path: 'services/writing',       element: <Writing /> },
      { path: 'services/speaking',      element: <Speaking /> },
      { path: 'services/mock-tests',    element: <MockTestsPage /> },
      { path: 'services/analytics',     element: <Analytics /> },
      { path: 'skill-tests',            element: <SkillTestsPage /> },
