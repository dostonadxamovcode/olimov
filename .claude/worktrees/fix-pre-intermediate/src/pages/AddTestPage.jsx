...
const COLLECTION_MAP = {
  ...
  Pre_Intermediate: 'preIntermediateTests',
  intermediate:     'intermediateTests',
  advanced:         'advancedTests',
}

const toCollection = (level) => COLLECTION_MAP[level] ?? `${level.toLowerCase()}Tests`
...
export default function AddTestPage() {
  ...
  const buildDoc = () => {
    ...
    return { ...base, correct_answer: correctAnswer.trim() }
  }
